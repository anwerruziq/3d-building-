  ...
  head: () => ({
    meta: [
      { title: "الأفق العقارية — تطوير عقاري برؤية عصرية" },
      {
        name: "description",
        content:
          "جولة افتراضية في مشاريع الأفق العقارية. اكتشف الفخامة والتصميم العصري في مشاريعنا السكنية والتجارية.",
      },
      { property: "og:title", content: "الأفق العقارية — نبني المستقبل" },
